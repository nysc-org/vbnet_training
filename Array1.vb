''Creating an Array
''An array is data structure that stores a fixed-size
''sequential collection of elements of
''the same type. An array is used to store a collection
''of data, but it is often more useful
''to think of an array as a collection of variables
''of the same type.
'Module Array1
'    'Sub Main()
'    '    Dim n(10) As Integer
...
'        Dim b As Integer()() = New Integer(7)() {}
'        b(0) = New Integer() {1, 0}
'        b(1) = New Integer() {3, 2}
'        b(2) = New Integer() {5, 4}
'        b(3) = New Integer() {7, 6}
